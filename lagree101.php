...
<section class="header-section">
	<div class="container">
		<div class="row">
			<h1 class="header-title">LAGREE 101</h1>
		</div>
	</div>
</section>
...
<section class="sub-header-section">
	<div class="container">
		<div class="row articles-category">
			<a href="#3" class="selected">ALL ARTICLES</a>
			<a href="#3">LAGREE 101</a>
			<a href="#3">NEWS AND UPDATES</a>
			<a href="#3">THE SCIENCE</a>
			<a href="#3">STUDENT OF THE MONTH</a>
			<a href="#3">THE MEGAFORMER CHALLENGE</a>
		</div>
	</div>
</section>
